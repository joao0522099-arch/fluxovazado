            ...
            {isOwner ? (
                <>
                    <div className="mb-4 text-center">
                        <img src={coverImage || 'https://via.placeholder.com/300x100?text=Capa'} className="cover-preview-img" alt="Capa" />
                        <button onClick={() => document.getElementById('coverInput')?.click()} className="text-[#00c2ff] text-sm underline">Alterar Capa</button>
                        <input type="file" id="coverInput" hidden accept="image/*" onChange={handleFileChange} />
                    </div>
